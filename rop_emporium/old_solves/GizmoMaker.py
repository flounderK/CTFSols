...
class GizmoMaker:
    ...
    def execute(self, name, *args, subargs=None):
        ...
        if self.actions[name].get("Sub-Execution") is not None and subargs is not None:
            self.actions[name]["Sub-Execution"]["args"] = subargs
